...
async def show_guide(message: Message, state: FSMContext):
    ...
    text = (
        ...
        "⚠️ <b>Muhim eslatma</b>\n"
        "<b>Triggerlarga - Telegram maxfiylik siyosatiga zid keluvchi - Siyosiy ma'lumotlar, zo'ravonlikni targ'ib qiluvchi matnlar, 18+ matnlar, umumiy odob - axloqni buzadigan matnlarni kiritmaslik tavsiya qilinadi, telegram maxfiyligiga zid harakatlar akkount spam bo'lishi, muzlatilinishi, yoki ban bo'lishi mumkin!</b>\n\n"
